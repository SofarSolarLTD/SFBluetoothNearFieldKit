#
#  Be sure to run `pod spec lint SFBluetoothNearFieldKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "guoyanhong" => "guoyanhong@sofarsolar.com" }
  # Or just: spec.author    = "guoyanhong"
  # spec.authors            = { "guoyanhong" => "guoyanhong@sofarsolar.com" }
  # spec.social_media_url   = "https://twitter.com/guoyanhong"
  ...
  spec.source       = { :git => "https://github.com/SofarSolarLTD/SFBluetoothNearFieldKit.git", :tag => "#{spec.version}" }
